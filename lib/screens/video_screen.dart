...
import 'package:video_demo/widgets/video_section.dart';
...
class _VideoScreenState extends State<VideoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<VideoCubit, double?>(
        builder: (context, panelHeight) {
          return SlidingUpPanel(
            maxHeight: panelHeight ??
                MediaQuery.of(context).size.height * .61, //624.625,
            minHeight: 50,
            parallaxEnabled: true,
            parallaxOffset: .5,
            body: const VideoSection(),
            panelBuilder: (sc) => CommentesPanel(scrollController: sc),
